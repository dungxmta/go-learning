...
import (
	...
	"testProject/learning/example/kafka_consumer/pkg/comsumer"
	"testProject/learning/example/kafka_consumer/pkg/producer"
)
...
func main() {
	...
	case MultiBatchMode:
		...
		consumer, err := consumer.StartMultiBatchConsumer(broker, topic, 8)
		if err != nil {
			panic(err)
		}
		defer consumer.Close()
